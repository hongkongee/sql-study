...
-- 사본 테이블 생성
-- 사본 테이블을 생성할 때 그냥 생성 -> 조회된 데이터까지 모두 복사
-- WHERE절에 false값(1 = 2) 지정 -> 테이블의 구조만 복사되고 데이터는 복사 x
...
UPDATE emps 
SET phone_number = '010.3333.7777', manager_id = 102
WHERE employee_id = 100;
SELECT * FROM emps;
